*** Settings ***
Documentation     Reading a single Stock Operation Type.
Resource          resources/inventory.resource
Suite Setup       Run Keywords    Create Authorized API Session
...               AND    Ensure Stock Operation Type Under Test
Test Tags         inventory    stock_operation_type    get
...
Get With Columns Succeeds
    ${resp}=    GET On Session    api    ${STOCK_OPERATION_TYPE_API}/${STOCK_OPERATION_TYPE_ID}
    ...    params=${{ {'fields': ['code', 'name', 'operation_code']} }}
...
Get With Not Found Id Fails
    [Tags]    negative
    ${resp}=    GET On Session    api    ${STOCK_OPERATION_TYPE_API}/${NOT_FOUND_ID}    expected_status=any
    Response Should Be Not Found Error    ${resp}

Get With Invalid Id Format Fails
    [Tags]    negative
    ${resp}=    GET On Session    api    ${STOCK_OPERATION_TYPE_API}/not-existing-1234567890123
    ...    expected_status=any
