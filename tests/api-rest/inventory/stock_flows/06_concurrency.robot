...
Two Reservations Against One Balance Do Not Over Reserve
    ...
    POST On Session    api    ${STOCK_TRANSFER_API}/${first_id}/confirm    json=${{ {'org_id': $INV_ORG_ID} }}    expected_status=any
    POST On Session    api    ${STOCK_TRANSFER_API}/${second_id}/confirm    json=${{ {'org_id': $INV_ORG_ID} }}    expected_status=any
    ...
    POST On Session    api    ${STOCK_TRANSFER_API}/${first_id}/reserve    json=${{ {'org_id': $INV_ORG_ID} }}    expected_status=any
    POST On Session    api    ${STOCK_TRANSFER_API}/${second_id}/reserve    json=${{ {'org_id': $INV_ORG_ID} }}    expected_status=any
    ...
    ...    POST On Session    api    ${STOCK_TRANSFER_API}/${first_id}/cancel    json=${{ {'org_id': $INV_ORG_ID} }}    expected_status=any
