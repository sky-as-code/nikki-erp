...
BEGIN
	...
	IF EXISTS (
		...
		('01K1H8N3L0WX4Q6S8YRKT3D2A2', 'Executive Office', NULL, ARRAY['01JWNY20G23KD4RV5VWYABQYHD', '01K1H8N3L0WX4Q6S8YRKT3D2A2']::varchar[], NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01JWNY20G23KD4RV5VWYABQYHD'),
		('01K1H8N3L0WX4Q6S8YRKT3D2A3', 'Operations Division', NULL, ARRAY['01JWNY20G23KD4RV5VWYABQYHD', '01K1H8N3L0WX4Q6S8YRKT3D2A2', '01K1H8N3L0WX4Q6S8YRKT3D2A3']::varchar[], '01K1H8N3L0WX4Q6S8YRKT3D2A2', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01JWNY20G23KD4RV5VWYABQYHD'),
		('01K1H8N3L0WX4Q6S8YRKT3D2A4', 'Product Engineering Department', NULL, ARRAY['01JWNY20G23KD4RV5VWYABQYHD', '01K1H8N3L0WX4Q6S8YRKT3D2A2', '01K1H8N3L0WX4Q6S8YRKT3D2A3', '01K1H8N3L0WX4Q6S8YRKT3D2A4']::varchar[], '01K1H8N3L0WX4Q6S8YRKT3D2A3', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01JWNY20G23KD4RV5VWYABQYHD'),
		('01K1H8N3L0WX4Q6S8YRKT3D2A5', 'Engineering Division', NULL, ARRAY['01K1H7M2K9VW3P5R7XQJY2C1Z9', '01K1H8N3L0WX4Q6S8YRKT3D2A5']::varchar[], NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01K1H7M2K9VW3P5R7XQJY2C1Z9'),
		('01K1H8N3L0WX4Q6S8YRKT3D2A6', 'Platform Engineering Department', NULL, ARRAY['01K1H7M2K9VW3P5R7XQJY2C1Z9', '01K1H8N3L0WX4Q6S8YRKT3D2A5', '01K1H8N3L0WX4Q6S8YRKT3D2A6']::varchar[], '01K1H8N3L0WX4Q6S8YRKT3D2A5', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01K1H7M2K9VW3P5R7XQJY2C1Z9'),
		('01K1H8N3L0WX4Q6S8YRKT3D2C0', 'Sales and Marketing Division', NULL, ARRAY['01K02G6J1CYAN9K8V4PAGSQ5Z8', '01K1H8N3L0WX4Q6S8YRKT3D2C0']::varchar[], NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01K02G6J1CYAN9K8V4PAGSQ5Z8'),
		('01K1H8N3L0WX4Q6S8YRKT3D2C1', 'Sales Department', NULL, ARRAY['01K02G6J1CYAN9K8V4PAGSQ5Z8', '01K1H8N3L0WX4Q6S8YRKT3D2C0', '01K1H8N3L0WX4Q6S8YRKT3D2C1']::varchar[], '01K1H8N3L0WX4Q6S8YRKT3D2C0', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01K02G6J1CYAN9K8V4PAGSQ5Z8'),
		('01K1H8N3L0WX4Q6S8YRKT3D2C2', 'Marketing Department', NULL, ARRAY['01K02G6J1CYAN9K8V4PAGSQ5Z8', '01K1H8N3L0WX4Q6S8YRKT3D2C0', '01K1H8N3L0WX4Q6S8YRKT3D2C2']::varchar[], '01K1H8N3L0WX4Q6S8YRKT3D2C0', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text, NOW(), NULL, '01K02G6J1CYAN9K8V4PAGSQ5Z8');
	END IF;
	...
	IF EXISTS (
		...
		INSERT INTO "ident_group_user_rel" ("id", "group_id", "user_id") VALUES
	...
	IF EXISTS (
		...
		INSERT INTO "ident_org_user_rel" ("id", "org_id", "user_id") VALUES
