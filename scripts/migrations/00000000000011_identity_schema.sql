...
CREATE TABLE "ident_organizations" ("id" character varying NOT NULL, "created_at" timestamptz NOT NULL, "deleted_at" timestamptz NULL, "display_name" character varying NOT NULL, "etag" character varying NOT NULL, "status" character varying NOT NULL, "slug" character varying NOT NULL, "updated_at" timestamptz NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "ident_groups" ("id" character varying NOT NULL, "created_at" timestamptz NOT NULL, "description" character varying NULL, "email" character varying NULL, "etag" character varying NOT NULL, "name" character varying NOT NULL COLLATE "vi-x-icu", "updated_at" timestamptz NULL, "org_id" character varying NULL, PRIMARY KEY ("id"), CONSTRAINT "ident_groups_ident_organizations_org" FOREIGN KEY ("org_id") REFERENCES "ident_organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
