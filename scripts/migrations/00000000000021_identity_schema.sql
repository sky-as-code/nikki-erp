...
CREATE TABLE "ident_organizations" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "ident_organizations_core_enums_org_status" FOREIGN KEY ("status_id") REFERENCES "core_enums" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE "ident_users" (
  ...
  "status_id" character varying NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "ident_users_core_enums_user_status" FOREIGN KEY ("status_id") REFERENCES "core_enums" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT "ident_users_ident_hierarchy_levels_hierarchy" FOREIGN KEY ("hierarchy_id") REFERENCES "ident_hierarchy_levels" ("id") ON UPDATE NO ACTION ON DELETE SET NULL
);
