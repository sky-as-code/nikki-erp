...
CREATE TABLE "ident_hierarchy_levels" ("id" character varying NOT NULL, "created_at" timestamptz NOT NULL, "deleted_at" timestamptz NULL, "deleted_by" character varying NULL, "etag" character varying NOT NULL, "name" character varying NOT NULL, "updated_at" timestamptz NULL, "parent_id" character varying NULL, "org_id" character varying NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "ident_hierarchy_levels_ident_hierarchy_levels_parent" FOREIGN KEY ("parent_id") REFERENCES "ident_hierarchy_levels" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "ident_hierarchy_levels_ident_organizations_org" FOREIGN KEY ("org_id") REFERENCES "ident_organizations" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
