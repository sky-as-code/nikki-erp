...
-- Create "users" table
CREATE TABLE "users" ("id" character varying NOT NULL, "avatar_url" character varying NULL, "created_at" timestamptz NOT NULL, "created_by" character varying NOT NULL, "display_name" character varying NOT NULL, "email" character varying NOT NULL, "etag" character varying NOT NULL, "failed_login_attempts" bigint NOT NULL DEFAULT 0, "last_login_at" timestamptz NULL, "locked_until" timestamptz NULL, "must_change_password" boolean NOT NULL DEFAULT true, "password_hash" character varying NOT NULL, "password_changed_at" timestamptz NOT NULL, "status" character varying NOT NULL DEFAULT 'inactive', "updated_at" timestamptz NOT NULL, "updated_by" character varying NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "organizations" ("id" character varying NOT NULL, "created_at" timestamptz NOT NULL, "created_by" character varying NOT NULL, "display_name" character varying NOT NULL, "etag" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'inactive', "slug" character varying NOT NULL, "updated_at" timestamptz NOT NULL, PRIMARY KEY ("id"));
