...
BEGIN
	IF EXISTS (
		...
		-- ('01KF326DEC4ND7PK91AZQY0TJ0', 'AuthzAction', 'authz_action', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		-- ('01JWNX10DN9E2PVZTVPJNTWR7D', 'AuthzEntitlement', 'iam_entitlement', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYWE9FBX2WTMYZMR9XHHX6', 'IAM Resource', 'iam_resource', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYV4RQ1ZKWG8RE0RMFTVCM', 'IAM Role', 'iam_role', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNX10DN9E2PVZTVPJNTWR7D', 'IAM Entitlement', 'iam_entitlement', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KF32E4TSX9DVV9KVKBS7GQ0T', 'IAM Grant Request', 'iam_grant_request', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYQ2A04PPV4135QGXX7W0M', 'IAM User', 'iam_user', NULL, 'nikkierp', 'tenant', 'org', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYQNN68RKN62TNG5K0CPCE', 'IAM Group', 'iam_group', NULL, 'nikkierp', 'tenant', 'org', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYQTHN6JTRNWKJ1BMCYB80', 'IAM Organization', 'iam_org', NULL, 'nikkierp', 'tenant', 'tenant', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWNYRSKZ56EAE2QRFHJWRZPT', 'IAM Organizational Unit', 'iam_orgunit', NULL, 'nikkierp', 'tenant', 'org', NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text);
	END IF;
	...
	IF EXISTS (
		...
		('01JWP88N498RQS88TYVJ4Z20EX', 'Domain Administrator - All Permissions', 'All permissions for domain administrator', '*:*:tenant', NULL, NULL, '01JWP72JJCDT4M0J8MSS51MN3T', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		
		--  Org Administrator (requires membership): All actions on all resources under orgs which user has membership
		('01KNHHJY19XTT7QB7X9K9DJ2W7', 'Org Administrator (membership) - All Permissions', 'All permissions for org administrator (membership)', '*:*:org', NULL, NULL, '01KNHHJY194Y2F0KB34C4YVHC7', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		...
		('01JWP8EARV3B9A1HWFPMQZQ6HZ', 'Identity Readonly - Read Users', 'Read users in Identity module', 'read:iam_user:tenant', '01JWNZ3XVWDP73JGHRRBFAHQYJ', '01JWNYQ2A04PPV4135QGXX7W0M', '01JWP80E084MTYF2C882WNR6MJ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8EFENXFNN17GSEJP0RCXZ', 'Identity Readonly - Read Groups', 'Read groups in Identity module', 'read:iam_group:tenant', '01JWNZ516R64X2S8A7STFXTP9B', '01JWNYQNN68RKN62TNG5K0CPCE', '01JWP80E084MTYF2C882WNR6MJ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),

		-- Identity module Administrator: All actions on Identity resources
		('01JWP8KSP3Q3YH6RKND552DWRR', 'Identity Admin - All User actions', 'All user actions in Identity module', '*:iam_user:tenant', NULL, '01JWNYQ2A04PPV4135QGXX7W0M', '01JWP80NHTHXSZDB1MZJXQ0MGQ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8KP39GKAH67FEAC7TZ631', 'Identity Admin - All Group actions', 'All group actions in Identity module', '*:iam_group:tenant', NULL, '01JWNYQNN68RKN62TNG5K0CPCE', '01JWP80NHTHXSZDB1MZJXQ0MGQ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8KK6K1M9WMP59BBAGEMB1', 'Identity Admin - All Organization actions', 'All organization actions in Identity module', '*:iam_org:tenant', NULL, '01JWNYQTHN6JTRNWKJ1BMCYB80', '01JWP80NHTHXSZDB1MZJXQ0MGQ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8KG15N26CRWNRM6F5CB29', 'Identity Admin - All Organizational Units actions', 'All organizational units actions in Identity module', '*:iam_orgunit:tenant', NULL, '01JWNYRSKZ56EAE2QRFHJWRZPT', '01JWP80NHTHXSZDB1MZJXQ0MGQ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),

		-- Identity module User Manager: All actions on Identity resources
		('01KNHHJY192QRXZCD7VP5HPPYG', 'Identity User Manager - All User actions', 'All user actions in Identity module', '*:iam_user:tenant', NULL, '01JWNYQ2A04PPV4135QGXX7W0M', '01JWPB7TC3CG1EB567WYQCJM79', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19KR6DK03ZBZ09KXPM', 'Identity User Manager - All Group actions', 'All group actions in Identity module', '*:iam_group:tenant', NULL, '01JWNYQNN68RKN62TNG5K0CPCE', '01JWPB7TC3CG1EB567WYQCJM79', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		
		-- Authorize module Readonly: Read actions on Authorize resources
		('01JWPA3A4J2644C24V86419A2V', 'Authorize Readonly - Read Resources', 'Read resources in Authorize module', 'read:iam_resource:tenant', '01JWNYZEVSH78T2SH7WP47KDRM', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19ZDZFQDG71WJETFFH', 'Authorize Readonly - Read Roles', 'Read roles in Authorize module', 'read:iam_role:tenant', '01JWNZ1D53FREVN8WX0Z7GZ1PS', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNV107H9ROENTREADH2P6QK', 'Authorize Readonly - Read Entitlements', 'Read entitlements in Authorize module', 'read:iam_entitlement:tenant', '01JWNYK975JE0PKC1NRAB68D9C', '01JWNX10DN9E2PVZTVPJNTWR7D', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19TQPRN03XDDEKQ6PE', 'Authorize Readonly - Read Grant Request', 'Read grant requests in Authorize module', 'read:iam_grant_request:tenant', '01JWNZ2N37F8ZXHIHI17QYNG6R', '01KF32E4TSX9DVV9KVKBS7GQ0T', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),

		-- Authorize module Administrator: All actions on Authorize resources
		('01JWPA35MPHG33G77FKQNYJS21', 'Authorize Admin - All Resource actions', 'All resource actions in Authorize module', '*:iam_resource:tenant', NULL, '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP80WR22SAG8Z7EYKDB00K6', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWPA3232EYYN4HQMWBBV345B', 'Authorize Admin - All Role actions', 'All role actions in Authorize module', '*:iam_role:tenant', NULL, '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP80WR22SAG8Z7EYKDB00K6', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNV107H9ADENTALLH2P6QK7', 'Authorize Admin - All Entitlement actions', 'All entitlement actions in Authorize module', '*:iam_entitlement:tenant', NULL, '01JWNX10DN9E2PVZTVPJNTWR7D', '01JWP80WR22SAG8Z7EYKDB00K6', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JW197DCKNR9DD16MP9TYA89J', 'Authorize Admin - All Grant Request actions', 'All grant and revoke request actions in Authorize module', '*:iam_grant_request:tenant', NULL, '01KF32E4TSX9DVV9KVKBS7GQ0T', '01JWP80WR22SAG8Z7EYKDB00K6', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),

		-- Authorize module Moderator: All actions on Resource, Role except delete
		('01JWP8KCVWVYDSQ6C8SNDQD5F6', 'Authorize Moderator - Create Resources', 'Create resources in Authorize module', 'create:iam_resource:tenant', '01JWNYZ5EPJJMA3D367XMYEMM2', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8KCVWVYDSQ6C8SNDQD5F7', 'Authorize Moderator - Update Resources', 'Update resources in Authorize module', 'update:iam_resource:tenant', '01JWY2HF8E72PQM8QHY0CHSVBT', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8KCVWVYDSQ6C8SNDQD5F9', 'Authorize Moderator - Read Resources', 'Read resources in Authorize module', 'read:iam_resource:tenant', '01JWNYZEVSH78T2SH7WP47KDRM', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z5', 'Authorize Moderator - Create Roles', 'Create roles in Authorize module', 'create:iam_role:tenant', '01JWNZ14EZ00S2HWZD3Z7VANJK', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z6', 'Authorize Moderator - Update Roles', 'Update roles in Authorize module', 'update:iam_role:tenant', '01JWNZ1A1MNC7X5AVVPM14EC3P', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z7', 'Authorize Moderator - Read Roles', 'Read roles in Authorize module', 'read:iam_role:tenant', '01JWNZ1D53FREVN8WX0Z7GZ1PS', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP810BRSH9GWCYQC463K012', 'tenant', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
