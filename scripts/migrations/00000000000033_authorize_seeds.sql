...
BEGIN
	...
	IF EXISTS (
		...
		('01JWP8EARV3B9A1HWFPMQZQ6HZ', 'Identity Readonly - View Users', 'View:*.IdentityUser', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ3XVWDP73JGHRRBFAHQYJ', '01JWNYQ2A04PPV4135QGXX7W0M', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		...
		('01JWP8KSP3Q3YH6RKND552DWRR', 'Identity Admin - All User Actions', '*:*.IdentityUser', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYQ2A04PPV4135QGXX7W0M', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		...
		('01JWP940XSBXNAN8BEV00W9DTH', 'Org Administrator - My Company All Actions', '*:01JWNY20G23KD4RV5VWYABQYHD.*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', '01JWNY20G23KD4RV5VWYABQYHD', NULL, NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint);
	END IF;
