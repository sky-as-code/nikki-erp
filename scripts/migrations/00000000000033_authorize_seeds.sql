...
BEGIN
	IF EXISTS (
		...
		('01JWNYQ2A04PPV4135QGXX7W0M', NOW(), 'IdentityUser', 'nikki_application', 'domain', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
	...
	IF EXISTS (
		...
		('01JWNZ992AFRE8YEA70Z7GZ123', 'AddEntitlement', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01THANGD53FREVN8WX07GDUYEN', 'RemoveEntitlement', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		-- AuthzRoleSuite
	...
	IF EXISTS (
		...
		-- Identity module Admin => user 01JWNXT3EY7FG47VDJTEPTDC98
		('01JWP80NHTHXSZDB1MZJXQ0MGQ', 'user', '01JWNXT3EY7FG47VDJTEPTDC98', '01JWNNJGS70Y07MBEV3AQ0M526'),
		-- Authorize module Admin => user 01JWNXT3EY7FG47VDJTEPTDC98
		('01JWP80WR22SAG8Z7EYKDB00K6', 'user', '01JWNXT3EY7FG47VDJTEPTDC98', '01JWNNJGS70Y07MBEV3AQ0M526');
	END IF;
	...
	IF EXISTS (
		...
		('01JWP88N78POZS88TYVJ4TQWY1', 'Authorize Admin - All Action Actions', 'AuthzAction:*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01KF326DEC4ND7PK91AZQY0TJ0', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		...
		('01JW197DCKNR9DD16MP9TYA89J', 'Authorize Admin - All GrantRequest Actions', 'AuthzGrantRequest:*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01KF32E4TSX9DVV9KVKBS7GQ0T', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01KF32E4TSX9DVV9KVKBS7GQ0T', 'Authorize Admin - All RevokeRequest Actions', 'AuthzRevokeRequest:*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01KF328VKN38VN16RG17C8BECB', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
	...
	IF EXISTS (
		...
		('01JWP8EARV3B9A1HWFPMQZQ6H1', '01JWP8EARV3B9A1HWFPMQZQ6HZ', 'nikki_role', '01JWP80E084MTYF2C882WNR6MJ', '01JWP80E084MTYF2C882WNR6MJ:*:IdentityUser:View', 'View', 'IdentityUser', NULL),
		('01JWP8EFENXFNN17GSEJP0RCX1', '01JWP8EFENXFNN17GSEJP0RCXZ', 'nikki_role', '01JWP80E084MTYF2C882WNR6MJ', '01JWP80E084MTYF2C882WNR6MJ:01K02G6J1CYAN9K8V4PAGSQ5Z8:IdentityGroup:View', 'View', 'IdentityGroup', '01K02G6J1CYAN9K8V4PAGSQ5Z8'),

		-- Identity module Administrator role gets all permissions on Identity resources
		('01JWP8KSP3Q3YH6RKND552DWR1', '01JWP8KSP3Q3YH6RKND552DWRR', 'nikki_role', '01JWP80NHTHXSZDB1MZJXQ0MGQ', '01JWP80NHTHXSZDB1MZJXQ0MGQ:*:IdentityUser:*', NULL, 'IdentityUser', NULL),
		('01JWP8KP39GKAH67FEAC7TZ632', '01JWP8KP39GKAH67FEAC7TZ631', 'nikki_role', '01JWP80NHTHXSZDB1MZJXQ0MGQ', '01JWP80NHTHXSZDB1MZJXQ0MGQ:01JWNY20G23KD4RV5VWYABQYHD:IdentityGroup:*', NULL, 'IdentityGroup', '01JWNY20G23KD4RV5VWYABQYHD'),
		...
		('01JWP8KG15N26CRWNRM6F5CB30', '01JWP8KG15N26CRWNRM6F5CB29', 'nikki_role', '01JWP80NHTHXSZDB1MZJXQ0MGQ', '01JWP80NHTHXSZDB1MZJXQ0MGQ:01JWNY20G23KD4RV5VWYABQYHD:IdentityHierarchyLevel:*', NULL, 'IdentityHierarchyLevel', '01JWNY20G23KD4RV5VWYABQYHD'),

		-- Identity module User Manager role gets all permissions on Users and Groups
		('01JWPBJFYTYJJTM799RBTKFE21', '01JWP8KSP3Q3YH6RKND552DWRR', 'nikki_role', '01JWPB7TC3CG1EB567WYQCJM79', '01JWPB7TC3CG1EB567WYQCJM79:*:IdentityUser:*', NULL, 'IdentityUser', NULL),
		('01JWPBJPV5H1ST6H7N21CMZ9YO', '01JWP8KP39GKAH67FEAC7TZ631', 'nikki_role', '01JWPB7TC3CG1EB567WYQCJM79', '01JWPB7TC3CG1EB567WYQCJM79:01JWNY20G23KD4RV5VWYABQYHD:IdentityGroup:*', NULL, 'IdentityGroup', '01JWNY20G23KD4RV5VWYABQYHD'),
		...
		('01JWTTM192EYTYAQ2MWBB67AAV', '01JWP88N78POZS88TYVJ4TQWY1', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:AuthzAction:*', NULL, 'AuthzAction', NULL),
		...
		('01JWGTQ892EYT8MJQA0BB561HH', '01JW197DCKNR9DD16MP9TYA89J', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:AuthzGrantRequest:*', NULL, 'AuthzGrantRequest', NULL),
		('01YUGTQ89ASMHT71QA0BKUIQ23', '01KF32E4TSX9DVV9KVKBS7GQ0T', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:AuthzRevokeRequest:*', NULL, 'AuthzRevokeRequest', NULL),
