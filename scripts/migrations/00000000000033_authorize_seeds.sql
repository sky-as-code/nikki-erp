...
BEGIN
	...
	IF EXISTS (
		...
		INSERT INTO "authz_entitlements" ("id", "action_expr", "created_at", "created_by", "scope_ref", "action_id", "resource_id", "etag") VALUES
		-- Domain Administrator: All actions on all resources
		('01JWP88N498RQS88TYVJ4Z20EX', '*:*:*.*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		
		-- Identity module Readonly: View actions on Identity resources
		('01JWP8EARV3B9A1HWFPMQZQ6HZ', 'View:*.IdentityUser', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ3XVWDP73JGHRRBFAHQYJ', '01JWNYQ2A04PPV4135QGXX7W0M', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8EFENXFNN17GSEJP0RCXZ', 'View:*.IdentityGroup', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ516R64X2S8A7STFXTP9B', '01JWNYQNN68RKN62TNG5K0CPCE', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),

		-- Identity module Administrator: All actions on Identity resources
		('01JWP8KSP3Q3YH6RKND552DWRR', '*:*.IdentityUser', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYQ2A04PPV4135QGXX7W0M', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8KP39GKAH67FEAC7TZ631', '*:*.IdentityGroup', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYQNN68RKN62TNG5K0CPCE', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8KK6K1M9WMP59BBAGEMB1', '*:*.IdentityOrganization', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYQTHN6JTRNWKJ1BMCYB80', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8KG15N26CRWNRM6F5CB29', '*:*.IdentityHierarchyLevel', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYRSKZ56EAE2QRFHJWRZPT', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),

		-- Authorize module Readonly: View actions on Authorize resources
		('01JWPA3A4J2644C24V86419A2V', 'View:*.AuthzEntitlement', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNYK975JE0PKC1NRAB68D9C', '01JWNX10DN9E2PVZTVPJNTWR7D', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),

		-- Authorize module Administrator: All actions on Authorize resources
		('01JWPA35MPHG33G77FKQNYJS21', '*:*.AuthzResource', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYWE9FBX2WTMYZMR9XHHX6', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWPA3232EYYN4HQMWBBV345B', '*:*.AuthzRole', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYV4RQ1ZKWG8RE0RMFTVCM', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWPA2YP0HTKY290T7570N7QF', '*:*.AuthzRoleSuite', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNYW23X8CMREJ2Y9349BAE4', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWPA2SEP8T4S2VKAKYDYME64', '*:*.AuthzEntitlement', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, NULL, '01JWNX10DN9E2PVZTVPJNTWR7D', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),

		-- Authorize module Moderator: All actions on Resource, Action, Role and Role Suite (but not Entitlement)
		('01JWP8KCVWVYDSQ6C8SNDQD5F6', 'Create:*.AuthzResource', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNYZ5EPJJMA3D367XMYEMM2', '01JWNYWE9FBX2WTMYZMR9XHHX6', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8KCVWVYDSQ6C8SNDQD5F7', 'Update:*.AuthzResource', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWY2HF8E72PQM8QHY0CHSVBT', '01JWNYWE9FBX2WTMYZMR9XHHX6', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8KCVWVYDSQ6C8SNDQD5F9', 'View:*.AuthzResource', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNYZEVSH78T2SH7WP47KDRM', '01JWNYWE9FBX2WTMYZMR9XHHX6', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z5', 'Create:*.AuthzRole', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ14EZ00S2HWZD3Z7VANJK', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z6', 'Update:*.AuthzRole', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ1A1MNC7X5AVVPM14EC3P', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z7', 'View:*.AuthzRole', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ1D53FREVN8WX0Z7GZ1PS', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K6DQKNR910S6CP90P24N', 'Create:*.AuthzRoleSuite', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ29T8K173M5GA3HFXM1ME', '01JWNYW23X8CMREJ2Y9349BAE4', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K6DQKNR910S6CP90P25N', 'Update:*.AuthzRoleSuite', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ2H9TPQSKEPTZ5KPHRE3H', '01JWNYW23X8CMREJ2Y9349BAE4', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),
		('01JWP8K6DQKNR910S6CP90P26N', 'View:*.AuthzRoleSuite', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', NULL, '01JWNZ2N37F8ZXC6MTC7QYNG6R', '01JWNYW23X8CMREJ2Y9349BAE4', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint),

		-- Org Administrator: All actions on all resources in specific organization
		('01JWP940XSBXNAN8BEV00W9DTH', '*:01JWNY20G23KD4RV5VWYABQYHD.*', NOW(), '01JWNNJGS70Y07MBEV3AQ0M526', '01JWNY20G23KD4RV5VWYABQYHD', NULL, NULL, (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint);
	END IF;
	...
	IF EXISTS (
		...
		('01JWP8EARV3B9A1HWFPMQZQ6H1', '01JWP8EARV3B9A1HWFPMQZQ6HZ', 'nikki_role', '01JWP80E084MTYF2C882WNR6MJ', '01JWP80E084MTYF2C882WNR6MJ:View:*.IdentityUser', 'View', 'IdentityUser'),
		...
		('01JWP8KSP3Q3YH6RKND552DWR1', '01JWP8KSP3Q3YH6RKND552DWRR', 'nikki_role', '01JWP80NHTHXSZDB1MZJXQ0MGQ', '01JWP80NHTHXSZDB1MZJXQ0MGQ:*:*.IdentityUser', NULL, 'IdentityUser'),
		...
		('01JWPBJFYTYJJTM799RBTKFE21', '01JWP8KSP3Q3YH6RKND552DWRR', 'nikki_role', '01JWPB7TC3CG1EB567WYQCJM79', '01JWPB7TC3CG1EB567WYQCJM79:*:*.IdentityUser', NULL, 'IdentityUser'),
		...
		('01JWPA3A4J2644C24V86419A2V', '01JWPA3A4J2644C24V86419A2V', 'nikki_role', '01JWP80S5RXP8BD4YCY8ZHP7NZ', '01JWP80S5RXP8BD4YCY8ZHP7NZ:View:*.AuthzEntitlement', 'View', 'AuthzEntitlement'),

		-- Authorize module Administrator role gets all permissions on Authorize resources
		('01JWPA35MPHG33G77FKQNYJS21', '01JWPA35MPHG33G77FKQNYJS21', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:*.AuthzResource', NULL, 'AuthzResource'),
		('01JWPA3232EYYN4HQMWBBV345B', '01JWPA3232EYYN4HQMWBBV345B', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:*.AuthzRole', NULL, 'AuthzRole'),
		('01JWPA2YP0HTKY290T7570N7QF', '01JWPA2YP0HTKY290T7570N7QF', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:*.AuthzRoleSuite', NULL, 'AuthzRoleSuite'),
		('01JWPA2SEP8T4S2VKAKYDYME64', '01JWPA2SEP8T4S2VKAKYDYME64', 'nikki_role', '01JWP80WR22SAG8Z7EYKDB00K6', '01JWP80WR22SAG8Z7EYKDB00K6:*:*.AuthzEntitlement', NULL, 'AuthzEntitlement'),

		-- Authorize module Moderator role gets all permissions on Resource, Action, Role and Role Suite
		('01JWP8KCVWVYDSQ6C8SNDQD5F6', '01JWP8KCVWVYDSQ6C8SNDQD5F6', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Create:*.AuthzResource', 'Create', 'AuthzResource'),
		('01JWP8KCVWVYDSQ6C8SNDQD5F7', '01JWP8KCVWVYDSQ6C8SNDQD5F7', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Update:*.AuthzResource', 'Update', 'AuthzResource'),
		('01JWP8KCVWVYDSQ6C8SNDQD5F9', '01JWP8KCVWVYDSQ6C8SNDQD5F9', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:View:*.AuthzResource', 'View', 'AuthzResource'),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z5', '01JWP8K9QE8PW6BKZZ6EW9C9Z5', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Create:*.AuthzRole', 'Create', 'AuthzRole'),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z6', '01JWP8K9QE8PW6BKZZ6EW9C9Z6', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Update:*.AuthzRole', 'Update', 'AuthzRole'),
		('01JWP8K9QE8PW6BKZZ6EW9C9Z7', '01JWP8K9QE8PW6BKZZ6EW9C9Z7', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:View:*.AuthzRole', 'View', 'AuthzRole'),
		('01JWP8K6DQKNR910S6CP90P24N', '01JWP8K6DQKNR910S6CP90P24N', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Create:*.AuthzRoleSuite', 'Create', 'AuthzRoleSuite'),
		('01JWP8K6DQKNR910S6CP90P25N', '01JWP8K6DQKNR910S6CP90P25N', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:Update:*.AuthzRoleSuite', 'Update', 'AuthzRoleSuite'),
		('01JWP8K6DQKNR910S6CP90P26N', '01JWP8K6DQKNR910S6CP90P26N', 'nikki_role', '01JWP810BRSH9GWCYQC463K012', '01JWP810BRSH9GWCYQC463K012:View:*.AuthzRoleSuite', 'View', 'AuthzRoleSuite'),

		-- Org Administrator role gets all permissions on all resources in specific organization
		('01JWP940XSBXNAN8BEV00W9DTH', '01JWP940XSBXNAN8BEV00W9DTH', 'nikki_role', '01JWP72RCDK8NVBJMZTWJK9R97', '01JWP72RCDK8NVBJMZTWJK9R97:*:01JWNY20G23KD4RV5VWYABQYHD.*', NULL, NULL);
	END IF;
END $$;
