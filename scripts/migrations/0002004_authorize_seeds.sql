...
BEGIN
	...
	IF EXISTS (
		...
		('01JWNZ2NTDTKZXHIHI17QYNG6R', 'Read', 'read', NULL, '01KF328VKN38VN16RG17C8BECB', (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
	...
	IF EXISTS (
		...
		('01JWP8EARV3B9A1HWFPMQZQ6HZ', 'Identity Readonly - Read Users', 'Read users in Identity module', 'read:user:domain', '01JWNZ3XVWDP73JGHRRBFAHQYJ', '01JWNYQ2A04PPV4135QGXX7W0M', '01JWP80E084MTYF2C882WNR6MJ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01JWP8EFENXFNN17GSEJP0RCXZ', 'Identity Readonly - Read Groups', 'Read groups in Identity module', 'read:group:domain', '01JWNZ516R64X2S8A7STFXTP9B', '01JWNYQNN68RKN62TNG5K0CPCE', '01JWP80E084MTYF2C882WNR6MJ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		...
		('01JWPA3A4J2644C24V86419A2V', 'Authorize Readonly - Read Resources', 'Read resources in Authorize module', 'read:authz_resource:domain', '01JWNYZEVSH78T2SH7WP47KDRM', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19ZDZFQDG71WJETFFH', 'Authorize Readonly - Read Roles', 'Read roles in Authorize module', 'read:authz_role:domain', '01JWNZ1D53FREVN8WX0Z7GZ1PS', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19TQPRN03XDDEKQ6PE', 'Authorize Readonly - Read Grant Request', 'Read grant requests in Authorize module', 'read:authz_grant_request:domain', '01JWNZ2N37F8ZXHIHI17QYNG6R', '01KF32E4TSX9DVV9KVKBS7GQ0T', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		('01KNHHJY19CTEAPCBJE02P4ZTQ', 'Authorize Readonly - Read Revoke Request', 'Read revoke requests in Authorize module', 'read:authz_revoke_request:domain', '01JWNZ2N37F8ZXHIHI17QYNG6R', '01KF328VKN38VN16RG17C8BECB', '01JWP80S5RXP8BD4YCY8ZHP7NZ', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		...
		('01JWP8KCVWVYDSQ6C8SNDQD5F9', 'Authorize Moderator - Read Resources', 'Read resources in Authorize module', 'read:authz_resource:domain', '01JWNYZEVSH78T2SH7WP47KDRM', '01JWNYWE9FBX2WTMYZMR9XHHX6', '01JWP810BRSH9GWCYQC463K012', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
		...
		('01JWP8K9QE8PW6BKZZ6EW9C9Z7', 'Authorize Moderator - Read Roles', 'Read roles in Authorize module', 'read:authz_role:domain', '01JWNZ1D53FREVN8WX0Z7GZ1PS', '01JWNYV4RQ1ZKWG8RE0RMFTVCM', '01JWP810BRSH9GWCYQC463K012', 'domain', NULL, NULL, false, NOW(), (EXTRACT(EPOCH FROM clock_timestamp()) * 1e9)::bigint::text),
