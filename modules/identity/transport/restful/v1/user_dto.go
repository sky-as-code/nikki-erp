...
type UserDto struct {
	...
	Hierarchies []HierarchyLevelDto `json:"hierarchies,omitempty"`
...
func (this *UserDto) FromUser(user domain.User) {
	...
	this.Hierarchies = array.Map(user.Hierarchies, func(hierarchy domain.HierarchyLevel) HierarchyLevelDto {
