...
func EntitlementExpression(actionCode *string, resourceCode *string, scope ResourceScope, scopeId ...*model.Id) string {
	action := "*"
	resource := "*"
	sId := ""
	if actionCode != nil {
	...
	if scope == ResourceScopeOrgUnit && scopeId == nil {
...
func (this *Entitlement) CalculateExpression() string {
	...
	if scope != nil && *scope == ResourceScopeOrgUnit {
