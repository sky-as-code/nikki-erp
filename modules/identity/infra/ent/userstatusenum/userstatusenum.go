...
const (
	// Label holds the string label denoting the userstatusenum type in the database.
	Label = "user_status_enum"
	...
	EdgeUsers = "users"
	// Table holds the table name of the userstatusenum in the database.
	Table = "core_enums"
...
// Columns holds all SQL columns for userstatusenum fields.
var Columns = []string{
	FieldID,
	FieldEtag,
	FieldLabel,
...
// OrderOption defines the ordering options for the UserStatusEnum queries.
