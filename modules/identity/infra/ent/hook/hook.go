...
// The HierarchyLevelFunc type is an adapter to allow the use of ordinary
// function as HierarchyLevel mutator.
type HierarchyLevelFunc func(context.Context, *ent.HierarchyLevelMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f HierarchyLevelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HierarchyLevelMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f UserOrgFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserOrgMutation); ok {
		return f(ctx, mv)
	}
