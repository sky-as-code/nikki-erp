...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.CreateOrg)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.DeleteOrg)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.GetOrg)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.SearchOrgs)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.OrgExists)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.ManageOrgUsers)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.OrgSvc.UpdateOrg)
// }
