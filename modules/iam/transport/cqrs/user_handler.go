...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.CreateUser)
// }
...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.UpdateUser)
// }
...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.DeleteUser)
// }
...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.GetUser)
// }
...
func (this *UserHandler) GetEnabledUser(ctx context.Context, packet *cqrs.RequestPacket[it.GetUserQuery]) (*cqrs.Reply[dmodel.OpResult[models.User]], error) {
	return cqrs.ServePacket(ctx, string(c.IamModuleName), packet, this.UserSvc.GetEnabledUser)
}
...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.SearchUsers)
// }
...
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.UserSvc.UserExists)
// }
