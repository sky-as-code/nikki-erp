...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.CreateGroup)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.UpdateGroup)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.DeleteGroup)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.GetGroup)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.GroupExists)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.ManageGroupUsers)
// }
...
// ) {
// 	return cqrs.HandlePacket2(ctx, string(c.IamModuleName), packet, this.GroupSvc.SearchGroups)
// }
