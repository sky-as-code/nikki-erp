...
const (
	ResourceSchemaName = "iam_resource"
...
func (this *Resource) SetMaxScope(v *c.ResourceScope) {
	if v == nil {
...
func (this Resource) GetMinScope() *c.ResourceScope {
...
func (this *Resource) SetMinScope(v *c.ResourceScope) {
	if v == nil {
