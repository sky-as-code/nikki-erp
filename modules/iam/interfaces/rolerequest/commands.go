...
var createRoleRequestCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "createRoleRequest",
}
...
var deleteRoleRequestCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "deleteRoleRequest",
}
...
var getRoleRequestQueryType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "getRoleRequest",
}
...
var roleRequestExistsQueryType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "roleRequestExists",
}
...
var searchRoleRequestsQueryType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "searchRoleRequests",
}
...
var updateRoleRequestCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "role_request", Action: "updateRoleRequest",
}
