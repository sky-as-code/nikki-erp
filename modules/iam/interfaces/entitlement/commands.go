...
var createEntitlementCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "createEntitlement",
}
...
var deleteEntitlementCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "deleteEntitlement",
}
...
var getEntitlementQueryType = cqrs.RequestType{Module: "iam", Submodule: "entitlement", Action: "getEntitlement"}
...
type GetEntitlementResult = dyn.OpResult[dyn.SingleResultData[domain.Entitlement]]

var entitlementExistsQueryType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "entitlementExists",
}
...
var searchEntitlementsQueryType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "searchEntitlements",
}
...
var updateEntitlementCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "updateEntitlement",
}
...
var setEntitlementIsArchivedCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "setEntitlementIsArchived",
}
...
var manageEntitlementRolesCommandType = cqrs.RequestType{
	Module: "iam", Submodule: "entitlement", Action: "manageEntitlementRoles",
}
