...
const (
	MethodSettingSchemaName = "authenticate_method_setting"
	...
	return dmodel.DefineModel(MethodSettingSchemaName).
		...
		Field(
			dmodel.DefineField().Name(MethodSettingFieldSubjectRef).
				Label(model.NewLangJsonRefSf("fields.%s", MethodSettingFieldSubjectRef)).
				DataType(dmodel.FieldDataTypeUlid()).
				AutoGenerated(),
		).
		Field(
			dmodel.DefineField().Name(MethodSettingFieldSubjectSourceRef).
				Label(model.NewLangJsonRefSf("fields.%s", MethodSettingFieldSubjectSourceRef)).
