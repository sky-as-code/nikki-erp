...
func (this *PasswordDomainServiceImpl) validateCurrentAndTempPass(
	candidatePass string, passStore *models.PasswordStore,
...
func (this *PasswordDomainServiceImpl) verifyOtpAndRecovery(
	otpCode models.OtpCode, passStore *models.PasswordStore,
...
func (this *PasswordDomainServiceImpl) findPasswordStore(
	ctx corectx.Context, principalType models.PrincipalType, principalRef model.Id,
) (*models.PasswordStore, error) {
	passResult, err := this.passwordRepo.GetOne(ctx, dyn.RepoGetOneParam{
		Filter: dmodel.DynamicFields{
			...
			models.PasswordStoreFieldPrincipalId:   string(principalRef),
		},
	})
	if err != nil {
		return nil, err
...
func (this *PasswordDomainServiceImpl) upsertPassStore(
	ctx corectx.Context, curPassStore *models.PasswordStore, newPassStore models.PasswordStore,
) error {
	if curPassStore != nil {
