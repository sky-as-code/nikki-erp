...
// DynamicEntity is the schema-agnostic domain model of the composable engine. It carries
// nothing but the field map, which makes it usable as the TDomain type argument of the generic
// helpers in modules/core/dynamicmodel/crud and .../baserepo, no matter which schema the
// enclosing onion serves.
