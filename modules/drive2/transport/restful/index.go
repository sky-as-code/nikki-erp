...
import (
	...
	v1 "github.com/sky-as-code/nikki-erp/modules/drive2/transport/restful/v1"
)
...
func initV1(
	...
	// fileGroup.GET("/shares/ancestors", driveFileShareRest.GetDriveFileAncestorOwnersByFileId)
	// fileGroup.GET("/shares/resolved", driveFileShareRest.GetDriveFileResolvedSharesByFileId)
	// fileGroup.GET("/shares/users/:userId", driveFileShareRest.GetDriveFileUserShareDetails)
