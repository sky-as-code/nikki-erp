...
// services.ShouldSkipCascade and tested there; what follows covers the wiring the override adds:
...
func runCascadeRaw(
	...
	service := &ProductAppServiceImpl{DynamicResourceService: base}
...
// is services.ShouldSkipCascade; this asserts the loop honours it and writes variant ids.
