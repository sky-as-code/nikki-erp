...
import (
	...
	itAttributeGroup "github.com/sky-as-code/nikki-erp/modules/inventory/attributegroup/interfaces"
...
func (r *AttributeGroupEntRepository) Create(ctx crud.Context, attributeGroup *itAttributeGroup.AttributeGroup) (*itAttributeGroup.AttributeGroup, error) {
...
func (r *AttributeGroupEntRepository) Update(ctx crud.Context, attributeGroup *itAttributeGroup.AttributeGroup, prevEtag model.Etag) (*itAttributeGroup.AttributeGroup, error) {
...
// ✅ Find by ID
func (r *AttributeGroupEntRepository) FindById(ctx crud.Context, query itAttributeGroup.FindByIdParam) (*itAttributeGroup.AttributeGroup, error) {
...
// ✅ Search (advanced)
func (r *AttributeGroupEntRepository) Search(ctx crud.Context, param itAttributeGroup.SearchParam) (*crud.PagedResult[itAttributeGroup.AttributeGroup], error) {
...
func (r *AttributeGroupEntRepository) ParseSearchGraph(criteria *string) (*orm.Predicate, []orm.OrderOption, ft.ValidationErrors) {
	return db.ParseSearchGraphStr[ent.AttributeGroup, itAttributeGroup.AttributeGroup](criteria, entAttributeGroup.Label)
}
