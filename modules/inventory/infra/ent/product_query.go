...
type ProductQuery struct {
	...
	withAttributeGroup     *AttributeGroupQuery
	withUnit               *UnitQuery
...
func (pq *ProductQuery) QueryVariant() *VariantQuery {
	query := (&VariantClient{config: pq.config}).Query()
...
func (pq *ProductQuery) QueryAttribute() *AttributeQuery {
	query := (&AttributeClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryAttributeGroup chains the current query on the "attribute_group" edge.
func (pq *ProductQuery) QueryAttributeGroup() *AttributeGroupQuery {
	query := (&AttributeGroupClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryUnit() *UnitQuery {
	query := (&UnitClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) QueryProductCategoryRel() *ProductCategoryRelQuery {
	query := (&ProductCategoryRelClient{config: pq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := pq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (pq *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withVariant:            pq.withVariant.Clone(),
		withAttribute:          pq.withAttribute.Clone(),
		withProductCategory:    pq.withProductCategory.Clone(),
		withAttributeGroup:     pq.withAttributeGroup.Clone(),
		withUnit:               pq.withUnit.Clone(),
		withProductCategoryRel: pq.withProductCategoryRel.Clone(),
...
func (pq *ProductQuery) WithVariant(opts ...func(*VariantQuery)) *ProductQuery {
	query := (&VariantClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withVariant = query
	return pq
}
...
func (pq *ProductQuery) WithAttribute(opts ...func(*AttributeQuery)) *ProductQuery {
	query := (&AttributeClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withAttribute = query
	return pq
}
...
// WithAttributeGroup tells the query-builder to eager-load the nodes that are connected to
// the "attribute_group" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithAttributeGroup(opts ...func(*AttributeGroupQuery)) *ProductQuery {
	query := (&AttributeGroupClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withAttributeGroup = query
	return pq
}
...
func (pq *ProductQuery) WithUnit(opts ...func(*UnitQuery)) *ProductQuery {
	query := (&UnitClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (pq *ProductQuery) WithProductCategoryRel(opts ...func(*ProductCategoryRelQuery)) *ProductQuery {
	query := (&ProductCategoryRelClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withProductCategoryRel = query
	return pq
}
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	var (
		...
		loadedTypes = [6]bool{
			pq.withVariant != nil,
			pq.withAttribute != nil,
			pq.withProductCategory != nil,
			pq.withAttributeGroup != nil,
			pq.withUnit != nil,
			pq.withProductCategoryRel != nil,
		}
	)
	...
	if query := pq.withVariant; query != nil {
		if err := pq.loadVariant(ctx, query, nodes,
			func(n *Product) { n.Edges.Variant = []*Variant{} },
			func(n *Product, e *Variant) { n.Edges.Variant = append(n.Edges.Variant, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withAttribute; query != nil {
		if err := pq.loadAttribute(ctx, query, nodes,
			func(n *Product) { n.Edges.Attribute = []*Attribute{} },
			func(n *Product, e *Attribute) { n.Edges.Attribute = append(n.Edges.Attribute, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := pq.withAttributeGroup; query != nil {
		if err := pq.loadAttributeGroup(ctx, query, nodes,
			func(n *Product) { n.Edges.AttributeGroup = []*AttributeGroup{} },
			func(n *Product, e *AttributeGroup) { n.Edges.AttributeGroup = append(n.Edges.AttributeGroup, e) }); err != nil {
			return nil, err
		}
	}
	if query := pq.withUnit; query != nil {
		if err := pq.loadUnit(ctx, query, nodes, nil,
			func(n *Product, e *Unit) { n.Edges.Unit = e }); err != nil {
			return nil, err
		}
	}
	if query := pq.withProductCategoryRel; query != nil {
		if err := pq.loadProductCategoryRel(ctx, query, nodes,
			func(n *Product) { n.Edges.ProductCategoryRel = []*ProductCategoryRel{} },
			func(n *Product, e *ProductCategoryRel) {
...
func (pq *ProductQuery) loadVariant(ctx context.Context, query *VariantQuery, nodes []*Product, init func(*Product), assign func(*Product, *Variant)) error {
	...
	query.Where(predicate.Variant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.VariantColumn), fks...))
	}))
...
func (pq *ProductQuery) loadAttribute(ctx context.Context, query *AttributeQuery, nodes []*Product, init func(*Product), assign func(*Product, *Attribute)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attribute.FieldProductID)
	}
	query.Where(predicate.Attribute(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.AttributeColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadProductCategory(ctx context.Context, query *ProductCategoryQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductCategory)) error {
	...
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "product_category" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (pq *ProductQuery) loadAttributeGroup(ctx context.Context, query *AttributeGroupQuery, nodes []*Product, init func(*Product), assign func(*Product, *AttributeGroup)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attributegroup.FieldProductID)
	}
	query.Where(predicate.AttributeGroup(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.AttributeGroupColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (pq *ProductQuery) loadUnit(ctx context.Context, query *UnitQuery, nodes []*Product, init func(*Product), assign func(*Product, *Unit)) error {
...
func (pq *ProductQuery) loadProductCategoryRel(ctx context.Context, query *ProductCategoryRelQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductCategoryRel)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Product)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(productcategoryrel.FieldProductID)
	}
	query.Where(predicate.ProductCategoryRel(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(product.ProductCategoryRelColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
