// Package message is the port for Inventory's outbound integration events. It must not be confused with
...
type IntegrationEvent struct {
	...
	// Payload is self-contained by design: a consumer reading back into Inventory to interpret it would
