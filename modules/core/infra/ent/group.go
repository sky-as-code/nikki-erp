...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldID, group.FieldName, group.FieldDescription, group.FieldStatus, group.FieldCreatedBy, group.FieldUpdatedBy, group.FieldDeletedBy:
	...
	for i := range columns {
		...
		case group.FieldStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				gr.Status = group.Status(value.String)
			}
