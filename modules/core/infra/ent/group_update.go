...
func (gu *GroupUpdate) SetStatus(gr group.Status) *GroupUpdate {
	gu.mutation.SetStatus(gr)
	return gu
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (gu *GroupUpdate) SetNillableStatus(gr *group.Status) *GroupUpdate {
	if gr != nil {
		gu.SetStatus(*gr)
	}
	return gu
...
// SetStatus sets the "status" field.
func (guo *GroupUpdateOne) SetStatus(gr group.Status) *GroupUpdateOne {
	guo.mutation.SetStatus(gr)
	return guo
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (guo *GroupUpdateOne) SetNillableStatus(gr *group.Status) *GroupUpdateOne {
	if gr != nil {
		guo.SetStatus(*gr)
	}
	return guo
