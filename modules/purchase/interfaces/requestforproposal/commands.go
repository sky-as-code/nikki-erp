...
type CreateRequestForProposalCommand struct{ models.RequestForProposal }
...
func (CreateRequestForProposalCommand) GetSchema() *dmodel.ModelSchema {
	return dmodel.GetSchema(models.RequestForProposalSchemaName)
}

type CreateRequestForProposalResult = dyn.OpResult[models.RequestForProposal]

var updateCommandType = cqrs.RequestType{Module: "purchase", Submodule: "requestforproposal", Action: "update"}

type UpdateRequestForProposalCommand struct{ models.RequestForProposal }
...
type GetRequestForProposalResult = dyn.OpResult[models.RequestForProposal]
...
type SearchRequestForProposalsResultData = dyn.PagedResultData[models.RequestForProposal]
