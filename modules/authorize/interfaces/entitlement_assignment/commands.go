...
// type CreateEntitlementAssignmentResult = crud.OpResult[*domain.EntitlementGrant]
...
// type GetAllEntitlementAssignmentBySubjectResult = crud.OpResult[[]domain.EntitlementGrant]
...
// type GetAllEntitlementAssignmentByEntitlementIdResult = crud.OpResult[[]domain.EntitlementGrant]
...
// type GetViewsByIdResult = crud.OpResult[[]domain.EntitlementGrant]
...
// type GetByIdResult = crud.OpResult[*domain.EntitlementGrant]
...
// type GetEntitlementAssignmentByFilterResult = crud.OpResult[*domain.EntitlementGrant]
