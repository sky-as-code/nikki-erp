...
// 	ListActionNamesByResourceId(ctx crud.Context, resourceId model.Id) ([]string, error)
// 	ListEntitlementNamesByResourceId(ctx crud.Context, resourceId model.Id) ([]string, error)
