...
// 		this.Etag = *entitlement.GetEtag()
// 	}
// 	if entitlement.GetName() != nil {
// 		this.Name = *entitlement.GetName()
// 	}
// 	this.Description = entitlement.GetDescription()
// 	this.ActionId = entitlement.GetActionId()
// 	this.ResourceId = entitlement.GetResourceId()
// 	this.ActionExpr = entitlement.GetActionExpr()
// 	if entitlement.GetCreatedBy() != nil {
// 		this.CreatedBy = *entitlement.GetCreatedBy()
// 	}
// 	this.Resource = nil
// 	this.Action = nil
// 	this.Subject = nil
...
// 	this.FromEntitlement(entitlement)
