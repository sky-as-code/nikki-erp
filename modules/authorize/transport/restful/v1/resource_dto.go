...
// 	if rt := resource.GetResourceType(); rt != nil {
// 		this.ResourceType = string(*rt)
// 	}
// 	if resource.GetResourceRef() != nil {
// 		this.ResourceRef = *resource.GetResourceRef()
// 	}
// 	if st := resource.GetScopeType(); st != nil {
// 		this.ScopeType = string(*st)
// 	}
// 	this.Actions = nil
// }
