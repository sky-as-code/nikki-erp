...
// func (this *GrantRequestDto) FromGrantRequest(grantRequest domain.GrantRequest, grantResponses []domain.GrantResponse) {
...
// 	if grantRequest.TargetRef != nil {
// 		var name *string
// 		if grantRequest.TargetType != nil {
// 			switch *grantRequest.TargetType {
// 			case domain.GrantRequestTargetTypeRole:
// 				name = grantRequest.TargetRoleName
// 			case domain.GrantRequestTargetTypeSuite:
// 				name = grantRequest.TargetSuiteName
// 			}
// 		}
// 		this.Target.FromTargetSummary(*grantRequest.TargetRef, name)
// 	}

// 	if grantResponses != nil {
// 		this.GrantResponses = array.Map(grantResponses, func(grantResponse domain.GrantResponse) GrantResponseDto {
...
// 		item.FromGrantRequest(grantRequest, nil)
// 		return item
// 	})
// }
