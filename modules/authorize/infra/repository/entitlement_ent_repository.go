...
// func ptrIdToString(id *model.Id) *string {
// 	if id == nil {
// 		return nil
// 	}
// 	s := string(*id)
...
// 		SetID(*entitlement.GetId()).
// 		SetEtag(*entitlement.GetEtag()).
// 		SetName(*entitlement.GetName()).
// 		SetNillableDescription(entitlement.GetDescription()).
// 		SetNillableResourceID(ptrIdToString(entitlement.GetResourceId())).
// 		SetNillableActionID(ptrIdToString(entitlement.GetActionId())).
// 		SetActionExpr(*entitlement.GetActionExpr()).
// 		SetCreatedBy(string(*entitlement.GetCreatedBy())).
...
// 	updation := this.entitlementClient(ctx).UpdateOneID(*entitlement.GetId()).
// 		SetNillableDescription(entitlement.GetDescription()).
// 		Where(entEntitlement.EtagEQ(prevEtag))

// 	if len(updation.Mutation().Fields()) > 0 {
// 		updation.SetEtag(*entitlement.GetEtag())
// 	}
