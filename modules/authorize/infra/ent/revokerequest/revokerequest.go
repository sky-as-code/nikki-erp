...
const (
	// Label holds the string label denoting the revokerequest type in the database.
	Label = "revoke_request"
	...
	RoleSuiteTable = "authz_revoke_requests"
...
// OrderOption defines the ordering options for the RevokeRequest queries.
