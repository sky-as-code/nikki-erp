...
// QueryRoleSuites chains the current query on the "role_suites" edge.
func (rq *RoleQuery) QueryRoleSuites() *RoleSuiteQuery {
	query := (&RoleSuiteClient{config: rq.config}).Query()
...
func (rq *RoleQuery) QueryRoleUsers() *RoleUserQuery {
...
func (rq *RoleQuery) QueryGrantRequests() *GrantRequestQuery {
	query := (&GrantRequestClient{config: rq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := rq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (rq *RoleQuery) QueryRevokeRequests() *RevokeRequestQuery {
	query := (&RevokeRequestClient{config: rq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := rq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (rq *RoleQuery) QueryPermissionHistories() *PermissionHistoryQuery {
	query := (&PermissionHistoryClient{config: rq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := rq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (rq *RoleQuery) QueryRoleRolesuite() *RoleRoleSuiteQuery {
	query := (&RoleRoleSuiteClient{config: rq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := rq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (rq *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		withRoleSuites:          rq.withRoleSuites.Clone(),
		withRoleUsers:           rq.withRoleUsers.Clone(),
		withGrantRequests:       rq.withGrantRequests.Clone(),
		withRevokeRequests:      rq.withRevokeRequests.Clone(),
		withPermissionHistories: rq.withPermissionHistories.Clone(),
		withRoleRolesuite:       rq.withRoleRolesuite.Clone(),
...
// WithRoleSuites tells the query-builder to eager-load the nodes that are connected to
// the "role_suites" edge. The optional arguments are used to configure the query builder of the edge.
func (rq *RoleQuery) WithRoleSuites(opts ...func(*RoleSuiteQuery)) *RoleQuery {
	query := (&RoleSuiteClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withRoleSuites = query
	return rq
}
...
func (rq *RoleQuery) WithRoleUsers(opts ...func(*RoleUserQuery)) *RoleQuery {
	query := (&RoleUserClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withRoleUsers = query
	return rq
}
...
func (rq *RoleQuery) WithGrantRequests(opts ...func(*GrantRequestQuery)) *RoleQuery {
	query := (&GrantRequestClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withGrantRequests = query
	return rq
}
...
func (rq *RoleQuery) WithRevokeRequests(opts ...func(*RevokeRequestQuery)) *RoleQuery {
	query := (&RevokeRequestClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withRevokeRequests = query
	return rq
}
...
func (rq *RoleQuery) WithPermissionHistories(opts ...func(*PermissionHistoryQuery)) *RoleQuery {
	query := (&PermissionHistoryClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withPermissionHistories = query
	return rq
}
...
func (rq *RoleQuery) WithRoleRolesuite(opts ...func(*RoleRoleSuiteQuery)) *RoleQuery {
	query := (&RoleRoleSuiteClient{config: rq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rq.withRoleRolesuite = query
	return rq
}
...
func (rq *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	var (
		...
		_spec       = rq.querySpec()
		loadedTypes = [6]bool{
			rq.withRoleSuites != nil,
			rq.withRoleUsers != nil,
			rq.withGrantRequests != nil,
			rq.withRevokeRequests != nil,
			rq.withPermissionHistories != nil,
			rq.withRoleRolesuite != nil,
		}
	)
	...
	if query := rq.withRoleSuites; query != nil {
		if err := rq.loadRoleSuites(ctx, query, nodes,
			func(n *Role) { n.Edges.RoleSuites = []*RoleSuite{} },
			func(n *Role, e *RoleSuite) { n.Edges.RoleSuites = append(n.Edges.RoleSuites, e) }); err != nil {
			return nil, err
		}
	}
	if query := rq.withRoleUsers; query != nil {
		if err := rq.loadRoleUsers(ctx, query, nodes,
			func(n *Role) { n.Edges.RoleUsers = []*RoleUser{} },
			func(n *Role, e *RoleUser) { n.Edges.RoleUsers = append(n.Edges.RoleUsers, e) }); err != nil {
			return nil, err
		}
	}
	if query := rq.withGrantRequests; query != nil {
		if err := rq.loadGrantRequests(ctx, query, nodes,
			func(n *Role) { n.Edges.GrantRequests = []*GrantRequest{} },
			func(n *Role, e *GrantRequest) { n.Edges.GrantRequests = append(n.Edges.GrantRequests, e) }); err != nil {
			return nil, err
		}
	}
	if query := rq.withRevokeRequests; query != nil {
		if err := rq.loadRevokeRequests(ctx, query, nodes,
			func(n *Role) { n.Edges.RevokeRequests = []*RevokeRequest{} },
			func(n *Role, e *RevokeRequest) { n.Edges.RevokeRequests = append(n.Edges.RevokeRequests, e) }); err != nil {
			return nil, err
		}
	}
	if query := rq.withPermissionHistories; query != nil {
		if err := rq.loadPermissionHistories(ctx, query, nodes,
			func(n *Role) { n.Edges.PermissionHistories = []*PermissionHistory{} },
			func(n *Role, e *PermissionHistory) {
				n.Edges.PermissionHistories = append(n.Edges.PermissionHistories, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := rq.withRoleRolesuite; query != nil {
		if err := rq.loadRoleRolesuite(ctx, query, nodes,
			func(n *Role) { n.Edges.RoleRolesuite = []*RoleRoleSuite{} },
			func(n *Role, e *RoleRoleSuite) { n.Edges.RoleRolesuite = append(n.Edges.RoleRolesuite, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (rq *RoleQuery) loadRoleSuites(ctx context.Context, query *RoleSuiteQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleSuite)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(role.RoleSuitesTable)
		s.Join(joinT).On(s.C(rolesuite.FieldID), joinT.C(role.RoleSuitesPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(role.RoleSuitesPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.RoleSuitesPrimaryKey[1]))
	...
	neighbors, err := withInterceptors[[]*RoleSuite](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
	for _, n := range neighbors {
		nodes, ok := nids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected "role_suites" node returned %v`, n.ID)
		}
		for kn := range nodes {
			assign(kn, n)
		}
...
func (rq *RoleQuery) loadRoleUsers(ctx context.Context, query *RoleUserQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleUser)) error {
...
func (rq *RoleQuery) loadGrantRequests(ctx context.Context, query *GrantRequestQuery, nodes []*Role, init func(*Role), assign func(*Role, *GrantRequest)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(grantrequest.FieldTargetRoleID)
	}
	query.Where(predicate.GrantRequest(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.GrantRequestsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.TargetRoleID
		if fk == nil {
			return fmt.Errorf(`foreign-key "target_role_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "target_role_id" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (rq *RoleQuery) loadRevokeRequests(ctx context.Context, query *RevokeRequestQuery, nodes []*Role, init func(*Role), assign func(*Role, *RevokeRequest)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(revokerequest.FieldTargetRoleID)
	}
	query.Where(predicate.RevokeRequest(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.RevokeRequestsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (rq *RoleQuery) loadPermissionHistories(ctx context.Context, query *PermissionHistoryQuery, nodes []*Role, init func(*Role), assign func(*Role, *PermissionHistory)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(permissionhistory.FieldRoleID)
	}
	query.Where(predicate.PermissionHistory(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.PermissionHistoriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (rq *RoleQuery) loadRoleRolesuite(ctx context.Context, query *RoleRoleSuiteQuery, nodes []*Role, init func(*Role), assign func(*Role, *RoleRoleSuite)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Role)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(rolerolesuite.FieldRoleID)
	}
	query.Where(predicate.RoleRoleSuite(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(role.RoleRolesuiteColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
