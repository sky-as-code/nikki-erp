...
type GrantRequestMixin struct {
	mixin.Schema
}

func (GrantRequestMixin) Fields() []ent.Field {
	return []ent.Field{
		field.String("id").
			Immutable().
			StorageKey("id"),
...
func (GrantRequest) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "authz_grant_requests"},
	}
}

func (GrantRequest) Edges() []ent.Edge {
	return []ent.Edge{
...
func (GrantRequest) Mixin() []ent.Mixin {
	return []ent.Mixin{
		GrantRequestMixin{},
	}
}
