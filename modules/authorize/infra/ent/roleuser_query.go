...
func (ruq *RoleUserQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ruq *RoleUserQuery) FirstIDX(ctx context.Context) int {
...
func (ruq *RoleUserQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ruq *RoleUserQuery) OnlyIDX(ctx context.Context) int {
...
func (ruq *RoleUserQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (ruq *RoleUserQuery) IDsX(ctx context.Context) []int {
	ids, err := ruq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(roleuser.FieldApproverID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.RoleUser.Query().
//		Select(roleuser.FieldApproverID).
//		Scan(ctx, &v)
