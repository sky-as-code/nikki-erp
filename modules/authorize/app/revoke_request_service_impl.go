...
// func (this *RevokeRequestServiceImpl) classifyReceiverType(targetType *domain.GrantRequestReceiverType) domain.GrantRequestReceiverType {
// 	if *targetType == domain.GrantReqReceiverTypeUser {
// 		return domain.GrantReqReceiverTypeUser
// 	} else {
// 		return domain.GrantRequestReceiverTypeGroup
// 	}
// }
...
// 	if *dbRevokeRequest.ReceiverType == domain.GrantRequestReceiverTypeGroup {
