...
// 	actionService itAction.ActionDomainService,
...
// 			return this.entitlementRepo.DeleteHard(ctx, it.DeleteParam{Id: *model.GetId()})
// 		},
...
// 	dbEntitlement, err = this.entitlementRepo.FindById(ctx, it.FindByIdParam{Id: *entitlement.GetId()})
// 	fault.PanicOnErr(err)
...
// 	if entitlement.GetDescription() != nil {
// 		s := defense.SanitizePlainText(*entitlement.GetDescription(), true)
// 		entitlement.SetDescription(&s)
// 	}

// 	if entitlement.GetName() != nil {
// 		s := defense.SanitizePlainText(*entitlement.GetName(), true)
// 		entitlement.SetName(&s)
// 	}
// }

// func (this *EntitlementServiceImpl) setEntitlementDefaults(entitlement *domain.Entitlement) {
// 	if entitlement.GetId() == nil {
// 		idPtr, err := model.NewId()
// 		fault.PanicOnErr(err)
// 		entitlement.SetId(idPtr)
// 	}
// 	if entitlement.GetEtag() == nil {
// 		e := model.NewEtag()
// 		entitlement.SetEtag(*e)
// 	}
// }
...
// 	resourceName := "*"
// 	if resource != nil && resource.GetName() != nil {
// 		resourceName = *resource.GetName()
// 	}

// 	actionName := "*"
// 	if action != nil && action.GetName() != nil {
...
// 		if *entitlement.GetActionExpr() != expectedExpr {
...
// 		if resource != nil && action.GetResourceId() != nil && resource.GetId() != nil &&
// 			*action.GetResourceId() != *resource.GetId() {
...
// 	_, err := this.assignmentService.DeleteByEntitlementId(ctx, itAssignment.DeleteEntitlementAssignmentByEntitlementIdCommand{EntitlementId: *entitlement.GetId()})
// 	fault.PanicOnErr(err)
...
// 			EntitlementExpr: *entitlement.GetActionExpr(),
// 		},
// 	)
// 	fault.PanicOnErr(err)
