...
import (
	...
	apiVal "github.com/go-ozzo/ozzo-validation/v4"
)
...
func WrapTechnicalError(err error, message string, formatValues ...interface{}) AppError {
	if err == nil {
		return nil
	}
...
func WrapError(errCode string, err error, message string, formatValues ...interface{}) AppError {
	if err == nil {
		return nil
	}
...
func WrapBusinessError(err error, message string, formatValues ...interface{}) AppError {
	if err == nil {
		return nil
	}
	base := errorBase{
