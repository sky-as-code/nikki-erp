...
import (
	...
	fault "github.com/sky-as-code/nikki-erp/common/util/fault"
)
...
func (m *MockConfigLoader) Get(arg0 string) (string, fault.AppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(fault.AppError)
	return ret0, ret1
}
...
func (m *MockConfigLoader) Init() fault.AppError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Init")
	ret0, _ := ret[0].(fault.AppError)
	return ret0
}
